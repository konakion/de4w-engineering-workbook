...
`uv` keeps the project environment reproducible. FastAPI and `uvicorn` turn the trained Model into a small web service. Streamlit gives us a browser dashboard for teaching and live demos. `joblib` saves trained scikit-learn artifacts so they can be reused later.
:::
